...
class ConnectionManager
{
	...
	{
		return $this->byId( "kilua_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "kilua_at_localhost";
		$data["connName"] = "kilua at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;kilua;;1"; //currently unused
		
		$this->_connectionsIdByName["kilua at localhost"] = "kilua_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "kilua";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=kilua;OPTION=3";
		$connectionsData["kilua_at_localhost"] = $data;
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["album"] = "kilua_at_localhost";
		$connectionsIds["foto"] = "kilua_at_localhost";
		$connectionsIds["users"] = "kilua_at_localhost";
