...
$layout = new TLayout("register_basic_center", "DeliciousGreen", "MobileGreen");
$layout->version = 2;
...
$layout = new TLayout("register_success", "DeliciousGreen", "MobileGreen");
$layout->version = 2;
$layout->blocks["top"] = array();
$layout->containers["fields"] = array();
$layout->container_properties["fields"] = array(  );
...
//	processing alamat
	...
	$control_alamat->readWebValue($values, $blobfields, NULL, NULL, $filename_values);

//	processing email
	$control_email = $pageObject->getControl("email", $id);
	$control_email->readWebValue($values, $blobfields, NULL, NULL, $filename_values);

//	processing nama_lengkap
	$control_nama_lengkap = $pageObject->getControl("nama_lengkap", $id);
	$control_nama_lengkap->readWebValue($values, $blobfields, NULL, NULL, $filename_values);
