...
class tDAL
{
	var $tblkilua_at_localhost__album;
	var $tblkilua_at_localhost__foto;
	var $tblkilua_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "album", "varname" => "kilua_at_localhost__album", "altvarname" => "album", "connId" => "kilua_at_localhost", "schema" => "", "connName" => "kilua at localhost");
		$this->lstTables[] = array("name" => "foto", "varname" => "kilua_at_localhost__foto", "altvarname" => "foto", "connId" => "kilua_at_localhost", "schema" => "", "connName" => "kilua at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "kilua_at_localhost__users", "altvarname" => "users", "connId" => "kilua_at_localhost", "schema" => "", "connName" => "kilua at localhost");
	}
