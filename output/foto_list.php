...
$layout = new TLayout("list_centered_vert", "DeliciousGreen", "MobileGreen");
$layout->version = 2;
...
$layout = new TLayout("masterlist", "DeliciousGreen", "MobileGreen");
$layout->version = 2;
...
$page_layouts["album_masterlist"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["users_masterlist"] = $layout;
